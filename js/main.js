...
// --- [수정] 앱 초기화 로직 변경 ---
// export function initializeApp(patterns) { ... } 함수를 제거합니다.
// DOMContentLoaded 리스너를 제거합니다.
// 스크립트가 <body>의 끝에서 로드되므로 DOM은 이미 준비된 상태입니다.

// --- 앱 실행 ---
allPatterns = patternsData; // 1. 패턴 데이터 설정

// 2. DOM이 준비되었으므로 즉시 초기화 함수들 호출
initializeDOM();
cleanupOldStorage();
displayDate();
initializeCounts();
