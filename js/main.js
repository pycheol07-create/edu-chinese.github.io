            ...
            <div class="mt-6">
                ...
                <div id="practice-container-${index}" class="mt-3 bg-sky-50 p-4 rounded-lg relative" data-spree-count="0" data-spree-goal="5">
                    ...
                    <div class="mt-3 flex justify-between items-center">
                        <button id="check-practice-btn-${index}" data-answer="" data-pinyin="" data-input-id="practice-input-${index}" class="check-practice-btn bg-sky-500 hover:bg-sky-600 text-white font-bold py-2 px-4 rounded-lg whitespace-nowrap" style="display: none;">정답 확인</button>
                        <div id="practice-counter-${index}" class="text-sm text-gray-500 text-right">AI 연습문제 로딩 중...</div>
                    </div>
